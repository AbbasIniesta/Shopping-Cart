...
<section class="cform">
  ...
  <article class="form">      
  <div>Category Id</div>                                
  <input type="text" placeholder="" name="categoryId" id="categoryId" value="${category.categoryId}" readonly="true" >
    <div>Category Name</div>
    <input type="text" placeholder="" name="categoryName" id="categoryName" value="${category.categoryName}" >
      <div>Category Description</div>
    <input type="text" placeholder="" name="categoryDesc" id="categoryDesc" value="${category.categoryDesc}" >
      </article>
  <article class="btn">
